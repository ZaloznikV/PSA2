...
public class Main {
	...
	public static void main(String[] args) throws IOException {
		...
		float [][] bla = new float [50][18000];
			// VNESI POTI DATOTEK
		String vhodnaDatoteka = "PrimerA.txt";
		String izhodnaDatoteka = "test.txt";
		String resitve = "primerA.sol";
		...
		dn3.Resitev.resi(vhodnaDatoteka, izhodnaDatoteka);
		long t1 = System.currentTimeMillis();
		dn3.PreveriResitev.preveri(t0, t1, izhodnaDatoteka, resitve);
	}
}
